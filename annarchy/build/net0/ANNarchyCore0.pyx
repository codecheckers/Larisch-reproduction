...
cdef extern from "ANNarchy.h":
    ...
    # Population 3 (N2) : Monitor
    cdef cppclass PopRecorder3 (Monitor):
        PopRecorder3(vector[int], int, int, long) except +
        long int size_in_bytes()
        void clear()
    ...
    cdef cppclass ProjRecorder2 (Monitor):
        ProjRecorder2(vector[int], int, int, long) except +
...
cdef class pop0_wrapper :
    ...
    def __cinit__(self, size, times, delay):

        pop0.spike_times = times
        pop0.set_size(size)
        pop0.set_max_delay(delay)
    # Number of neurons
    property size:
        def __get__(self):
    ...
    cpdef get_spike_times(self):
        return pop0.spike_times
    cpdef set_spike_times(self, value):
        pop0.spike_times = value
        pop0.recompute_spike_times()
...
cdef class pop1_wrapper :
    ...
    def __cinit__(self, size, times, delay):
        ...
        pop1.spike_times = times
        pop1.set_size(size)
        pop1.set_max_delay(delay)
    # Number of neurons
    property size:
        def __get__(self):
    ...
    # Local parameter spike_times
    cpdef get_spike_times(self):
        return pop1.spike_times
    cpdef set_spike_times(self, value):
        pop1.spike_times = value
        pop1.recompute_spike_times()
...
cdef class pop3_wrapper :
    ...
    # Global parameter DeltaT
    cpdef double get_DeltaT(self):
        return pop3.get_DeltaT()
    cpdef set_DeltaT(self, double value):
        pop3.set_DeltaT(value)

    # Global parameter tauw
    cpdef double get_tauw(self):
        return pop3.get_tauw()
    cpdef set_tauw(self, double value):
        pop3.set_tauw(value)
    ...
    # Global parameter tauz
    cpdef double get_tauz(self):
        return pop3.get_tauz()
    cpdef set_tauz(self, double value):
        pop3.set_tauz(value)

    # Global parameter tauVT
    cpdef double get_tauVT(self):
        return pop3.get_tauVT()
    cpdef set_tauVT(self, double value):
        pop3.set_tauVT(value)
    ...
    # Global parameter VTMax
    cpdef double get_VTMax(self):
        return pop3.get_VTMax()
    cpdef set_VTMax(self, double value):
        pop3.set_VTMax(value)

    # Global parameter VTrest
    cpdef double get_VTrest(self):
        return pop3.get_VTrest()
    cpdef set_VTrest(self, double value):
        pop3.set_VTrest(value)

    # Global parameter taux
    cpdef double get_taux(self):
        return pop3.get_taux()
    cpdef set_taux(self, double value):
        pop3.set_taux(value)

    # Global parameter tauLTD
    cpdef double get_tauLTD(self):
        return pop3.get_tauLTD()
    cpdef set_tauLTD(self, double value):
        pop3.set_tauLTD(value)

    # Global parameter tauLTP
    cpdef double get_tauLTP(self):
        return pop3.get_tauLTP()
    cpdef set_tauLTP(self, double value):
        pop3.set_tauLTP(value)

    # Global parameter taumean
    cpdef double get_taumean(self):
        return pop3.get_taumean()
    cpdef set_taumean(self, double value):
        pop3.set_taumean(value)

    # Global parameter tau_gExc
    cpdef double get_tau_gExc(self):
        return pop3.get_tau_gExc()
    cpdef set_tau_gExc(self, double value):
        pop3.set_tau_gExc(value)

    # Local parameter inter_vm
    cpdef np.ndarray get_inter_vm(self):
        return np.array(pop3.get_inter_vm())
    cpdef set_inter_vm(self, np.ndarray value):
        pop3.set_inter_vm( value )
    cpdef double get_single_inter_vm(self, int rank):
        return pop3.get_single_inter_vm(rank)
    cpdef set_single_inter_vm(self, int rank, value):
        pop3.set_single_inter_vm(rank, value)

    # Local variable vm
    cpdef np.ndarray get_vm(self):
        return np.array(pop3.get_vm())
    cpdef set_vm(self, np.ndarray value):
        pop3.set_vm( value )
    cpdef double get_single_vm(self, int rank):
        return pop3.get_single_vm(rank)
    cpdef set_single_vm(self, int rank, value):
        pop3.set_single_vm(rank, value)

    # Local variable vmean
    cpdef np.ndarray get_vmean(self):
        return np.array(pop3.get_vmean())
    cpdef set_vmean(self, np.ndarray value):
        pop3.set_vmean( value )
    cpdef double get_single_vmean(self, int rank):
        return pop3.get_single_vmean(rank)
    cpdef set_single_vmean(self, int rank, value):
        pop3.set_single_vmean(rank, value)

    # Local variable umeanLTD
    cpdef np.ndarray get_umeanLTD(self):
        return np.array(pop3.get_umeanLTD())
    cpdef set_umeanLTD(self, np.ndarray value):
        pop3.set_umeanLTD( value )
    cpdef double get_single_umeanLTD(self, int rank):
        return pop3.get_single_umeanLTD(rank)
    cpdef set_single_umeanLTD(self, int rank, value):
        pop3.set_single_umeanLTD(rank, value)

    # Local variable umeanLTP
    cpdef np.ndarray get_umeanLTP(self):
        return np.array(pop3.get_umeanLTP())
    cpdef set_umeanLTP(self, np.ndarray value):
        pop3.set_umeanLTP( value )
    cpdef double get_single_umeanLTP(self, int rank):
        return pop3.get_single_umeanLTP(rank)
    cpdef set_single_umeanLTP(self, int rank, value):
        pop3.set_single_umeanLTP(rank, value)

    # Local variable xtrace
    cpdef np.ndarray get_xtrace(self):
        return np.array(pop3.get_xtrace())
    cpdef set_xtrace(self, np.ndarray value):
        pop3.set_xtrace( value )
    cpdef double get_single_xtrace(self, int rank):
        return pop3.get_single_xtrace(rank)
    cpdef set_single_xtrace(self, int rank, value):
        pop3.set_single_xtrace(rank, value)

    # Local variable wad
    cpdef np.ndarray get_wad(self):
        return np.array(pop3.get_wad())
    cpdef set_wad(self, np.ndarray value):
        pop3.set_wad( value )
    cpdef double get_single_wad(self, int rank):
        return pop3.get_single_wad(rank)
    cpdef set_single_wad(self, int rank, value):
        pop3.set_single_wad(rank, value)

    # Local variable z
    cpdef np.ndarray get_z(self):
        return np.array(pop3.get_z())
    cpdef set_z(self, np.ndarray value):
        pop3.set_z( value )
    cpdef double get_single_z(self, int rank):
        return pop3.get_single_z(rank)
    cpdef set_single_z(self, int rank, value):
        pop3.set_single_z(rank, value)

    # Local variable VT
    cpdef np.ndarray get_VT(self):
        return np.array(pop3.get_VT())
    cpdef set_VT(self, np.ndarray value):
        pop3.set_VT( value )
    cpdef double get_single_VT(self, int rank):
        return pop3.get_single_VT(rank)
    cpdef set_single_VT(self, int rank, value):
        pop3.set_single_VT(rank, value)

    # Local variable g_Exc
    cpdef np.ndarray get_g_Exc(self):
        return np.array(pop3.get_g_Exc())
    cpdef set_g_Exc(self, np.ndarray value):
        pop3.set_g_Exc( value )
    cpdef double get_single_g_Exc(self, int rank):
        return pop3.get_single_g_Exc(rank)
    cpdef set_single_g_Exc(self, int rank, value):
        pop3.set_single_g_Exc(rank, value)

    # Local variable state
    cpdef np.ndarray get_state(self):
        return np.array(pop3.get_state())
    cpdef set_state(self, np.ndarray value):
        pop3.set_state( value )
    cpdef double get_single_state(self, int rank):
        return pop3.get_single_state(rank)
    cpdef set_single_state(self, int rank, value):
        pop3.set_single_state(rank, value)

    # Local variable Spike
    cpdef np.ndarray get_Spike(self):
        return np.array(pop3.get_Spike())
    cpdef set_Spike(self, np.ndarray value):
        pop3.set_Spike( value )
    cpdef double get_single_Spike(self, int rank):
        return pop3.get_single_Spike(rank)
    cpdef set_single_Spike(self, int rank, value):
        pop3.set_single_Spike(rank, value)

    # Local variable resetvar
    cpdef np.ndarray get_resetvar(self):
        return np.array(pop3.get_resetvar())
    cpdef set_resetvar(self, np.ndarray value):
        pop3.set_resetvar( value )
    cpdef double get_single_resetvar(self, int rank):
        return pop3.get_single_resetvar(rank)
    cpdef set_single_resetvar(self, int rank, value):
        pop3.set_single_resetvar(rank, value)
...
cdef class proj2_wrapper :
    ...
    def __cinit__(self, synapses):
        ...
        cdef int nb_post = syn.post_rank.size()
        proj2.set_size( size )
        proj2.set_post_rank( syn.post_rank )
        proj2.set_pre_rank( syn.pre_rank )
    ...
    def set_post_rank(self, val):
        proj2.set_post_rank(val)
        proj2.inverse_connectivity_matrix()
    def pre_rank(self, int n):
        return proj2.get_pre_rank()[n]
    def pre_rank_all(self):
        return proj2.get_pre_rank()
    def set_pre_rank(self, val):
        proj2.set_pre_rank(val)
        proj2.inverse_connectivity_matrix()
    ...
    def set_w(self, value):
        proj2.set_w( value )
    def get_dendrite_w(self, int rank):
        return proj2.get_dendrite_w(rank)
    def set_dendrite_w(self, int rank, vector[double] value):
        proj2.set_dendrite_w(rank, value)
    def get_synapse_w(self, int rank_post, int rank_pre):
        return proj2.get_synapse_w(rank_post, rank_pre)
    def set_synapse_w(self, int rank_post, int rank_pre, double value):
        proj2.set_synapse_w(rank_post, rank_pre, value)



    # Global parameter vmean_fix
    def get_vmean_fix(self):
        return proj2.get_vmean_fix()
    def set_vmean_fix(self, value):
        proj2.set_vmean_fix(value)

    # Global parameter urefsquare
    def get_urefsquare(self):
        return proj2.get_urefsquare()
    def set_urefsquare(self, value):
        proj2.set_urefsquare(value)

    # Global parameter thetaLTD
    def get_thetaLTD(self):
        return proj2.get_thetaLTD()
    def set_thetaLTD(self, value):
        proj2.set_thetaLTD(value)

    # Global parameter thetaLTP
    def get_thetaLTP(self):
        return proj2.get_thetaLTP()
    def set_thetaLTP(self, value):
        proj2.set_thetaLTP(value)

    # Global parameter aLTD
    def get_aLTD(self):
        return proj2.get_aLTD()
    def set_aLTD(self, value):
        proj2.set_aLTD(value)

    # Global parameter aLTP
    def get_aLTP(self):
        return proj2.get_aLTP()
    def set_aLTP(self, value):
        proj2.set_aLTP(value)

    # Global parameter wMin
    def get_wMin(self):
        return proj2.get_wMin()
    def set_wMin(self, value):
        proj2.set_wMin(value)

    # Global parameter wMax
    def get_wMax(self):
        return proj2.get_wMax()
    def set_wMax(self, value):
        proj2.set_wMax(value)

    # Global parameter transmit
    def get_transmit(self):
        return proj2.get_transmit()
    def set_transmit(self, value):
        proj2.set_transmit(value)

    # Global parameter set_fix
    def get_set_fix(self):
        return proj2.get_set_fix()
    def set_set_fix(self, value):
        proj2.set_set_fix(value)

    # Local variable ltdTerm_fix
    def get_ltdTerm_fix(self):
        return proj2.get_ltdTerm_fix()
    def set_ltdTerm_fix(self, value):
        proj2.set_ltdTerm_fix( value )
    def get_dendrite_ltdTerm_fix(self, int rank):
        return proj2.get_dendrite_ltdTerm_fix(rank)
    def set_dendrite_ltdTerm_fix(self, int rank, vector[double] value):
        proj2.set_dendrite_ltdTerm_fix(rank, value)
    def get_synapse_ltdTerm_fix(self, int rank_post, int rank_pre):
        return proj2.get_synapse_ltdTerm_fix(rank_post, rank_pre)
    def set_synapse_ltdTerm_fix(self, int rank_post, int rank_pre, double value):
        proj2.set_synapse_ltdTerm_fix(rank_post, rank_pre, value)

    # Local variable ltdTerm
    def get_ltdTerm(self):
        return proj2.get_ltdTerm()
    def set_ltdTerm(self, value):
        proj2.set_ltdTerm( value )
    def get_dendrite_ltdTerm(self, int rank):
        return proj2.get_dendrite_ltdTerm(rank)
    def set_dendrite_ltdTerm(self, int rank, vector[double] value):
        proj2.set_dendrite_ltdTerm(rank, value)
    def get_synapse_ltdTerm(self, int rank_post, int rank_pre):
        return proj2.get_synapse_ltdTerm(rank_post, rank_pre)
    def set_synapse_ltdTerm(self, int rank_post, int rank_pre, double value):
        proj2.set_synapse_ltdTerm(rank_post, rank_pre, value)

    # Local variable ltpTerm
    def get_ltpTerm(self):
        return proj2.get_ltpTerm()
    def set_ltpTerm(self, value):
        proj2.set_ltpTerm( value )
    def get_dendrite_ltpTerm(self, int rank):
        return proj2.get_dendrite_ltpTerm(rank)
    def set_dendrite_ltpTerm(self, int rank, vector[double] value):
        proj2.set_dendrite_ltpTerm(rank, value)
    def get_synapse_ltpTerm(self, int rank_post, int rank_pre):
        return proj2.get_synapse_ltpTerm(rank_post, rank_pre)
    def set_synapse_ltpTerm(self, int rank_post, int rank_pre, double value):
        proj2.set_synapse_ltpTerm(rank_post, rank_pre, value)

    # Local variable deltaW
    def get_deltaW(self):
        return proj2.get_deltaW()
    def set_deltaW(self, value):
        proj2.set_deltaW( value )
    def get_dendrite_deltaW(self, int rank):
        return proj2.get_dendrite_deltaW(rank)
    def set_dendrite_deltaW(self, int rank, vector[double] value):
        proj2.set_dendrite_deltaW(rank, value)
    def get_synapse_deltaW(self, int rank_post, int rank_pre):
        return proj2.get_synapse_deltaW(rank_post, rank_pre)
    def set_synapse_deltaW(self, int rank_post, int rank_pre, double value):
        proj2.set_synapse_deltaW(rank_post, rank_pre, value)
...
# Population Monitor wrapper
cdef class PopRecorder3_wrapper(Monitor_wrapper):
    def __cinit__(self, list ranks, int period, period_offset, long offset):
        self.thisptr = new PopRecorder3(ranks, period, period_offset, offset)

    def size_in_bytes(self):
        return (<PopRecorder3 *>self.thisptr).size_in_bytes()

    def clear(self):
        (<PopRecorder3 *>self.thisptr).clear()


    property gL:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).gL
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).gL = val
    property record_gL:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_gL
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_gL = val
    def clear_gL(self):
        (<PopRecorder3 *>self.thisptr).gL.clear()

    property DeltaT:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).DeltaT
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).DeltaT = val
    property record_DeltaT:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_DeltaT
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_DeltaT = val
    def clear_DeltaT(self):
        (<PopRecorder3 *>self.thisptr).DeltaT.clear()

    property tauw:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).tauw
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).tauw = val
    property record_tauw:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_tauw
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_tauw = val
    def clear_tauw(self):
        (<PopRecorder3 *>self.thisptr).tauw.clear()

    property a:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).a
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).a = val
    property record_a:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_a
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_a = val
    def clear_a(self):
        (<PopRecorder3 *>self.thisptr).a.clear()

    property b:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).b
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).b = val
    property record_b:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_b
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_b = val
    def clear_b(self):
        (<PopRecorder3 *>self.thisptr).b.clear()

    property EL:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).EL
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).EL = val
    property record_EL:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_EL
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_EL = val
    def clear_EL(self):
        (<PopRecorder3 *>self.thisptr).EL.clear()

    property C:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).C
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).C = val
    property record_C:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_C
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_C = val
    def clear_C(self):
        (<PopRecorder3 *>self.thisptr).C.clear()

    property tauz:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).tauz
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).tauz = val
    property record_tauz:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_tauz
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_tauz = val
    def clear_tauz(self):
        (<PopRecorder3 *>self.thisptr).tauz.clear()

    property tauVT:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).tauVT
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).tauVT = val
    property record_tauVT:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_tauVT
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_tauVT = val
    def clear_tauVT(self):
        (<PopRecorder3 *>self.thisptr).tauVT.clear()

    property Isp:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).Isp
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).Isp = val
    property record_Isp:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_Isp
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_Isp = val
    def clear_Isp(self):
        (<PopRecorder3 *>self.thisptr).Isp.clear()

    property VTMax:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).VTMax
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).VTMax = val
    property record_VTMax:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_VTMax
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_VTMax = val
    def clear_VTMax(self):
        (<PopRecorder3 *>self.thisptr).VTMax.clear()

    property VTrest:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).VTrest
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).VTrest = val
    property record_VTrest:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_VTrest
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_VTrest = val
    def clear_VTrest(self):
        (<PopRecorder3 *>self.thisptr).VTrest.clear()

    property taux:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).taux
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).taux = val
    property record_taux:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_taux
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_taux = val
    def clear_taux(self):
        (<PopRecorder3 *>self.thisptr).taux.clear()

    property tauLTD:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).tauLTD
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).tauLTD = val
    property record_tauLTD:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_tauLTD
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_tauLTD = val
    def clear_tauLTD(self):
        (<PopRecorder3 *>self.thisptr).tauLTD.clear()

    property tauLTP:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).tauLTP
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).tauLTP = val
    property record_tauLTP:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_tauLTP
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_tauLTP = val
    def clear_tauLTP(self):
        (<PopRecorder3 *>self.thisptr).tauLTP.clear()

    property taumean:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).taumean
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).taumean = val
    property record_taumean:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_taumean
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_taumean = val
    def clear_taumean(self):
        (<PopRecorder3 *>self.thisptr).taumean.clear()

    property tau_gExc:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).tau_gExc
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).tau_gExc = val
    property record_tau_gExc:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_tau_gExc
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_tau_gExc = val
    def clear_tau_gExc(self):
        (<PopRecorder3 *>self.thisptr).tau_gExc.clear()

    property inter_vm:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).inter_vm
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).inter_vm = val
    property record_inter_vm:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_inter_vm
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_inter_vm = val
    def clear_inter_vm(self):
        (<PopRecorder3 *>self.thisptr).inter_vm.clear()

    property vm:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).vm
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).vm = val
    property record_vm:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_vm
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_vm = val
    def clear_vm(self):
        (<PopRecorder3 *>self.thisptr).vm.clear()

    property vmean:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).vmean
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).vmean = val
    property record_vmean:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_vmean
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_vmean = val
    def clear_vmean(self):
        (<PopRecorder3 *>self.thisptr).vmean.clear()

    property umeanLTD:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).umeanLTD
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).umeanLTD = val
    property record_umeanLTD:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_umeanLTD
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_umeanLTD = val
    def clear_umeanLTD(self):
        (<PopRecorder3 *>self.thisptr).umeanLTD.clear()

    property umeanLTP:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).umeanLTP
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).umeanLTP = val
    property record_umeanLTP:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_umeanLTP
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_umeanLTP = val
    def clear_umeanLTP(self):
        (<PopRecorder3 *>self.thisptr).umeanLTP.clear()

    property xtrace:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).xtrace
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).xtrace = val
    property record_xtrace:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_xtrace
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_xtrace = val
    def clear_xtrace(self):
        (<PopRecorder3 *>self.thisptr).xtrace.clear()

    property wad:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).wad
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).wad = val
    property record_wad:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_wad
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_wad = val
    def clear_wad(self):
        (<PopRecorder3 *>self.thisptr).wad.clear()

    property z:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).z
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).z = val
    property record_z:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_z
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_z = val
    def clear_z(self):
        (<PopRecorder3 *>self.thisptr).z.clear()

    property VT:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).VT
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).VT = val
    property record_VT:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_VT
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_VT = val
    def clear_VT(self):
        (<PopRecorder3 *>self.thisptr).VT.clear()

    property g_Exc:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).g_Exc
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).g_Exc = val
    property record_g_Exc:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_g_Exc
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_g_Exc = val
    def clear_g_Exc(self):
        (<PopRecorder3 *>self.thisptr).g_Exc.clear()

    property state:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).state
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).state = val
    property record_state:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_state
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_state = val
    def clear_state(self):
        (<PopRecorder3 *>self.thisptr).state.clear()

    property Spike:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).Spike
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).Spike = val
    property record_Spike:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_Spike
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_Spike = val
    def clear_Spike(self):
        (<PopRecorder3 *>self.thisptr).Spike.clear()

    property resetvar:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).resetvar
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).resetvar = val
    property record_resetvar:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_resetvar
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_resetvar = val
    def clear_resetvar(self):
        (<PopRecorder3 *>self.thisptr).resetvar.clear()

    property r:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).r
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).r = val
    property record_r:
        def __get__(self): return (<PopRecorder3 *>self.thisptr).record_r
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_r = val
    def clear_r(self):
        (<PopRecorder3 *>self.thisptr).r.clear()
    ...
    property record_spike:
        ...
        def __set__(self, val): (<PopRecorder3 *>self.thisptr).record_spike = val
    def clear_spike(self):
        (<PopRecorder3 *>self.thisptr).clear_spike()
...
# Projection Monitor wrapper
cdef class ProjRecorder2_wrapper(Monitor_wrapper):
    def __cinit__(self, list ranks, int period, int period_offset, long offset):
        self.thisptr = new ProjRecorder2(ranks, period, period_offset, offset)

    property vmean_fix:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).vmean_fix
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).vmean_fix = val
    property record_vmean_fix:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_vmean_fix
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_vmean_fix = val
    def clear_vmean_fix(self):
        (<ProjRecorder2 *>self.thisptr).vmean_fix.clear()

    property urefsquare:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).urefsquare
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).urefsquare = val
    property record_urefsquare:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_urefsquare
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_urefsquare = val
    def clear_urefsquare(self):
        (<ProjRecorder2 *>self.thisptr).urefsquare.clear()

    property thetaLTD:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).thetaLTD
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).thetaLTD = val
    property record_thetaLTD:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_thetaLTD
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_thetaLTD = val
    def clear_thetaLTD(self):
        (<ProjRecorder2 *>self.thisptr).thetaLTD.clear()

    property thetaLTP:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).thetaLTP
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).thetaLTP = val
    property record_thetaLTP:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_thetaLTP
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_thetaLTP = val
    def clear_thetaLTP(self):
        (<ProjRecorder2 *>self.thisptr).thetaLTP.clear()

    property aLTD:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).aLTD
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).aLTD = val
    property record_aLTD:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_aLTD
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_aLTD = val
    def clear_aLTD(self):
        (<ProjRecorder2 *>self.thisptr).aLTD.clear()

    property aLTP:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).aLTP
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).aLTP = val
    property record_aLTP:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_aLTP
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_aLTP = val
    def clear_aLTP(self):
        (<ProjRecorder2 *>self.thisptr).aLTP.clear()

    property wMin:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).wMin
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).wMin = val
    property record_wMin:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_wMin
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_wMin = val
    def clear_wMin(self):
        (<ProjRecorder2 *>self.thisptr).wMin.clear()

    property wMax:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).wMax
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).wMax = val
    property record_wMax:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_wMax
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_wMax = val
    def clear_wMax(self):
        (<ProjRecorder2 *>self.thisptr).wMax.clear()

    property transmit:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).transmit
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).transmit = val
    property record_transmit:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_transmit
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_transmit = val
    def clear_transmit(self):
        (<ProjRecorder2 *>self.thisptr).transmit.clear()

    property set_fix:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).set_fix
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).set_fix = val
    property record_set_fix:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_set_fix
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_set_fix = val
    def clear_set_fix(self):
        (<ProjRecorder2 *>self.thisptr).set_fix.clear()

    property ltdTerm_fix:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).ltdTerm_fix
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).ltdTerm_fix = val
    property record_ltdTerm_fix:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_ltdTerm_fix
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_ltdTerm_fix = val
    def clear_ltdTerm_fix(self):
        (<ProjRecorder2 *>self.thisptr).ltdTerm_fix.clear()

    property ltdTerm:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).ltdTerm
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).ltdTerm = val
    property record_ltdTerm:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_ltdTerm
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_ltdTerm = val
    def clear_ltdTerm(self):
        (<ProjRecorder2 *>self.thisptr).ltdTerm.clear()

    property ltpTerm:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).ltpTerm
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).ltpTerm = val
    property record_ltpTerm:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_ltpTerm
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_ltpTerm = val
    def clear_ltpTerm(self):
        (<ProjRecorder2 *>self.thisptr).ltpTerm.clear()

    property deltaW:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).deltaW
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).deltaW = val
    property record_deltaW:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_deltaW
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_deltaW = val
    def clear_deltaW(self):
        (<ProjRecorder2 *>self.thisptr).deltaW.clear()

    property w:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).w
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).w = val
    property record_w:
        def __get__(self): return (<ProjRecorder2 *>self.thisptr).record_w
        def __set__(self, val): (<ProjRecorder2 *>self.thisptr).record_w = val
    def clear_w(self):
        (<ProjRecorder2 *>self.thisptr).w.clear()
